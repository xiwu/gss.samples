...
//                }
    ...
    public void polling(String  destinationName, String listenerConfigFile, int remainderQueueNum) {
        ...
        try {
            ...
            if (receivedMessage != null) {
                ...
                logger.info("Received message: queueName=" + destinationName + " message: " + receivedMessage.getText());
            }
        } catch (Exception e) {
            e.printStackTrace();
