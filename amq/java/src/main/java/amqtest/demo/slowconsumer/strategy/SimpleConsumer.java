...
public class SimpleConsumer {
    ...
    public static void main(String args[]) {	
        ...
        try {
        	...
        	ActiveMQConnectionFactory factory = new ActiveMQConnectionFactory("admin","admin","failover:(tcp://localhost:61616?trace=true&useKeepAlive=false&wireFormat.maxInactivityDuration=20000,tcp://localhost:61618?trace=true&useKeepAlive=false&wireFormat.maxInactivityDuration=20000)");
