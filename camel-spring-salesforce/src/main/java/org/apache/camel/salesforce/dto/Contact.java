...
public class Contact extends AbstractSObjectBase {
    ...
    // JBoss_Fuse__c
    private Double JBoss_Fuse__c;

    @JsonProperty("JBoss_Fuse__c")
    public Double getJBoss_Fuse__c() {
        return this.JBoss_Fuse__c;
    }

    @JsonProperty("JBoss_Fuse__c")
    public void setJBoss_Fuse__c(Double JBoss_Fuse__c) {
        this.JBoss_Fuse__c = JBoss_Fuse__c;
    }
